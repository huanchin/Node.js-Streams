// read large text file from file system and send it to the client
// demostrate how to read large file by consuming streams

const fs = require("fs");
const server = require("http").createServer();

server.on("request", (req, res) => {
  // solution 1: file is too large! reading the whole file into a variable(data) and store it into memory can make the performance really bad
